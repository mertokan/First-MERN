...
export default function Home() {
  ...
  return (
    <div>
      ...
      <div className='container mx-auto p-3 flex flex-col gap-8 my-10'>
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            ...
            <div className='grid md:grid-flow-col md:auto-cols-auto md:grid-cols-none grid-cols-2 justify-items-center gap-4'>
              {offerListings.map((listing) => (
